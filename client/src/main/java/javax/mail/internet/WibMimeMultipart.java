 ...
 * Time: 11:48 AM
 */
public class WibMimeMultipart extends Multipart {
     ...
     */
    public WibMimeMultipart(String subtype) {
     ...
     */
    public WibMimeMultipart(DataSource dataSource) throws MessagingException {
        ds = dataSource;
